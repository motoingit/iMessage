            ...
            <Modal.Body className="isolate space-y-6 pt-4">
              ...
              <div className="flex items-center justify-between rounded-xl bg-white/5 p-4">
                <div>
                  ...
                  <p className="text-xs text-zinc-400 mt-0.5">Upload your own image to use as background.</p>
                </div>
                <input
                  type="file"
                  ref={fileInputRef}
              ...
              {allWallpapers.some((w) => w.id.startsWith("custom-")) ? (
                <section className="space-y-3">
                  <h3 className="text-sm font-medium text-zinc-400">My Uploads</h3>
              ...
              {WALLPAPER_SECTIONS.map((section) => {
                const sectionWallpapers = allWallpapers.filter((w) => w.category === section.id && !w.id.startsWith("custom-"));
